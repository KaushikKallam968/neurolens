    ...
    <div className="flex items-center justify-center min-h-[60vh]">
      ...
      >
        <Card className="p-8">
          ...
          <h2 className="font-display text-lg text-text-bright mb-6">
          ...
          <button
            onClick={() => onAuth.signInWithGoogle()}
            className="w-full mt-3 px-4 py-2.5 rounded-[var(--radius-sm)] border border-border
              text-text-main text-sm font-body hover:border-border-active transition-colors
